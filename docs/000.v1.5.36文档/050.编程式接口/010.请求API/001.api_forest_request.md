...
permalink: /pages/1.5.36/api_forest_request/
---
...
关于如何手动发送请求，请求参见《[执行请求](/pages/1.5.36/api_execute/)》
:::
...
在拦截器或 OnError、OnSuccess 等回调函数的参数中可以直接获取 Forest 请求对象，相关内容请参见《[拦截器](docs/1.5.36/interceptor)》
