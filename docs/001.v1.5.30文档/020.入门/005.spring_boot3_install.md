...
permalink: /pages/1.5.30/spring_boot3_install/
---
...
<code-group>
  ...
  ```groovy
  compile group: 'com.dtflys.forest', name: 'forest-spring-boot-starter', version: '1.5.30'
  ```
  </code-block>
</code-group>
...
<code-group>
  ...
  <code-block title="Gradle">
  ```groovy
compile group: 'com.dtflys.forest', name: 'forest-jakarta-xml', version: '1.5.30'
  ```
  </code-block>
</code-group>
