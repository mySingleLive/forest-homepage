...
permalink: /pages/1.5.30/spring_install/
---
...
<dependency>
  ...
  ```groovy
compile group: 'com.dtflys.forest', name: 'forest-core', version: '1.5.30'
compile group: 'com.dtflys.forest', name: 'forest-spring', version: '1.5.30'
  ```
  </code-block>
</code-group>
...
<code-group>
  ...
  <code-block title="Gradle">
  ```groovy
compile group: 'com.dtflys.forest', name: 'forest-jaxb', version: '1.5.30'
  ```
  </code-block>
</code-group>
