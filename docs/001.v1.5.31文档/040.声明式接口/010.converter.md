...
permalink: /pages/1.5.31/converter/
---
...
`@BodyType`的具体使用方式，请参见《[@BodyType 注解](/pages/1.5.31/http_body/#bodytype-注解)》
...
则要通过上文介绍的[配置方式](/pages/1.5.31/converter/#配置全局转换器)来指定全局转换具体是哪一个
:::
...
具体使用方式，请参见《[指定 Encoder](/pages/1.5.31/http_body/#指定-encoder)》和《[JSON 编码器快捷注解](/pages/1.5.31/http_body/#json-编码器快捷注解)》


## 自定义转换器

请参见 《[自定义转换器](/pages/1.5.31/custom_converter/)》
