...
permalink: /pages/1.5.31/spring_install/
---
...
<dependency>
  ...
  ```groovy
compile group: 'com.dtflys.forest', name: 'forest-core', version: '1.5.31'
compile group: 'com.dtflys.forest', name: 'forest-spring', version: '1.5.31'
  ```
  </code-block>
</code-group>
