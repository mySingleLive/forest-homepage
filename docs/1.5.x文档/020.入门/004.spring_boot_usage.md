...
permalink: /pages/spring_boot_usage/
---

在 Forest 依赖加入好，并配置好之后，就可以构建 HTTP 请求的接口了

如还没有添加好依赖或配置好，请参见《[Springboot环境安装](docs/1.5.x文档/020.入门/002.spring_boot_install.md)》和《[Springboot环境配置](docs/1.5.x文档/020.入门/003.spring_boot_config.md)》
