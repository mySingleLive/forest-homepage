...
permalink: /pages/1.6.1/spring_boot3_usage/
---

在 Forest 依赖加入好，并配置好之后，就可以构建 HTTP 请求的接口了

如还没有添加好依赖或配置好，请参见《[Springboot环境安装](/pages/1.6.1/spring_boot_install/)》和《[Springboot环境配置](/pages/1.6.1/spring_boot_config/)》
