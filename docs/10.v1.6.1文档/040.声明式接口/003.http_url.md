...
permalink: /pages/1.6.1/http_url/
---
...
基本`URL`设置方法就如 《[简单请求](/pages/1.6.1/build_interface/#简单请求)》 的例子所示，只要在`url`属性中填入完整的请求地址即可。
...
关于接口注解的具体使用方法，请参见《[接口注解](/pages/1.6.1/base_request)》
