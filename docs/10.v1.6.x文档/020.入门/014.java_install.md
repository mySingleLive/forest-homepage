...
permalink: /pages/1.6.x/java_install/
---
...
<dependency>
  ...
  ```groovy
compile group: 'com.dtflys.forest', name: 'forest-core', version: '1.6.x'
  ```
  </code-block>
</code-group>
...
<code-group>
  ...
  <code-block title="Gradle">
  ```groovy
compile group: 'com.dtflys.forest', name: 'forest-jakarta-xml', version: '1.6.x'
  ```
  </code-block>
</code-group>
