...
permalink: /pages/1.5.36/spring_boot3_install/
---
...
<code-group>
  ...
  ```groovy
  compile group: 'com.dtflys.forest', name: 'forest-spring-boot3-starter', version: '1.5.36'
  ```
  </code-block>
</code-group>

:::warning 注意
若您的项目是基于 <b>SpringBoot 1 或 2</b> 的，请参见《[Springboot环境安装](/pages/1.5.36/spring_boot_install/)》
:::
...
<code-group>
  ...
  <code-block title="Gradle">
  ```groovy
compile group: 'com.dtflys.forest', name: 'forest-jakarta-xml', version: '1.5.36'
  ```
  </code-block>
</code-group>
